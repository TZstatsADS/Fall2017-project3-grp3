...
```{r}
logisticRegression <- function(K = 2000, feature = HOG_features, label = fread("data/label_train.csv", stringsAsFactors = FALSE)){
  ...
  accuracy = mean(logistic_pred[,4] == dfTest$label)
