...
```{r}
# if(run.evaluation){
#   cat('baseline model accuracy:' ,mean(pred_label_base==label_test),'\n')
#   cat('adv1 model accuracy:' ,mean(pred_label_adv1==label_test),'\n')
#   cat('adv2 model accuracy:' ,mean(pred_label_adv2==label_test),'\n')
#   
# }
```
